...
- Создайте пароль для новой учетной записи GitHub и введите имя пользователя. ...
- Проверьте свою учетную запись , решив головоломку. ...
- После подтверждения учетной записи нажмите кнопку Создать учетную запись .
